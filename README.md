...
║  BUILD        AI-powered apps · LLM pipelines · Dev platforms      ║
║  LEARNING     KMP · LLM fine-tuning · RAG systems                  ║
║  ASK_ME       Android · FastAPI · Gemini OCR · Docker              ║
...
```bash
ramiz@dev:~$ cat ./contact.env
```

```ini
LINKEDIN   = linkedin.com/in/mohammad-ramiz-886468217
TWITTER    = twitter.com/mohammad__ramiz
KAGGLE     = kaggle.com/kobraop
EMAIL      = ramizanas6@gmail.com
PORTFOLIO  = mohammadramiz.in
```
...
```
┌──────────────────────────────────────────────────────────────────┐
│  ramiz@dev:~$ echo "Thanks for visiting"                         │
│  Thanks for visiting                                             │
│  ramiz@dev:~$ █                                                  │
└──────────────────────────────────────────────────────────────────┘
```
...
name        : Mohammad Ramiz
location    : India
focus       : Android · Python Backend · AI/ML
building    : AI-powered mobile apps, LLM pipelines, dev platforms
learning    : Kotlin Multiplatform · LLM fine-tuning · RAG systems
ask_me      : Android, FastAPI, Gemini OCR, ML pipelines, Docker
fun_fact    : Coding is my meditation — Kaggle is my dojo
```
